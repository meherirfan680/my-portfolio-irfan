      ...
      <div className="contact-container">
        ...
        <div className="container page-title text-center">
          ...
          <span className="title-head-subtitle">
            I’m always open to discussing SEO and web development projects.
          </span>
        </div>
        {/* Main Heading Ends */}
          ...
          <div className="row contact">
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+92 334 9955239</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">iamaamuhammadi</span>
                  </h6>
                </li>
              </ul>
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="facebook">
                    <a
                      target="_blank"
                      title="Facebook"
                      href="https://web.facebook.com/aamuhammadi/"
                    >
                  ...
                  <li className="twitter">
                    <a
                      target="_blank"
                      title="Twitter"
                      href="https://twitter.com/iamaamuhammadi"
                    >
                  ...
                  <li className="youtube">
                    <a
                      target="_blank"
                      title="Youtube"
                      href="https://www.youtube.com/c/AbdullahAmanatMuhammadi"
                    >
            ...
            <div className="col-12 col-md-8 col-xl-8 rightside">
              <p>
                ...
                something, please fill out the form below and I will reply you
                soon.
              </p>
